...
if( !cronjob_exists( '*/15    *    *    *    *    /usr/bin/php5.5 '.SITE_ROOT.'/reorg/console/job.php' )){
    shell_exec("crontab -l | { cat; echo '*/15    *    *    *    *    /usr/bin/php5.5 ".SITE_ROOT."/reorg/console/job.php'; } |crontab -");
}
